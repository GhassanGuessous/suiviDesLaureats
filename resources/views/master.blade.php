...
<body id="home" class="homepage">
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                        <span class="sr-only">Suivi Des Laureats</span>
    ...
    <section id="main-slider">
        <div class="owl-carousel">
            <div class="item" style="background-image: url(assets/images/bg1.jpg);">
                        ...
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <div class="carousel-content">
                                    <h2>Bienvenu 
                                        <br /><br />Application Suivi Des Laureats
                                    </h2>
                                    <p>École Nationale des Sciences Appliquées de Safi<br>
             ...
             <div class="item" style="background-image: url(assets/images/bg2.jpg);">
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 text-center">
    ...
    <section id="testimonial">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="assets/images/testimonail_1.jpg"></div>
                ...
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="assets/images/testimonail_2.jpg"></div>
                <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="assets/images/testimonail_3.jpg"></div>
                <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua Lorem ipsum dolor sit amet, consectetur.</p>
                ...
                <div class="col-sm-6">
                <div class="panel-one">
                <div class="user-img"><img alt="" src="assets/images/testimonail_4.jpg"></div>
                <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed doeiusmod tempor incididunt ut labore et dolore magna aliqua Lorem ipsum dolor sit amet, consectetur.</p>
 ...
 sed do ETX eiusmod tempor incididunt ut labore et</p>
    ...
    <footer id="footer">
        <div class="container text-center">
          All rights reserved © 2016 | <a href="https://www.pfind.com/goodies/bizexpress/">BizExpress Template</a> from <a href="http://www.pfind.com/goodies/">pFind.com</a>
        </div>
    </footer><!--/#footer-->
