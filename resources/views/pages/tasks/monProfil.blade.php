                ...
                <div class='box-form'>
                    ...
                    <div class='box-login'>
                      <div class='fieldset-body' id='login_form'>
                        ...
                        <img src="assets/images/users/user.1.jpg" class="monProfilImg">

                        <p class='field'><label for='user'>MAYZRANE Hassan (22 ans)</label></p>
                        <p class='field'><label for='pass'>Etudiant 4ème-année G.INFO</label></p>
                        <p class='field'><label for='pass'>mayzranehassan@gmail.com</label></p>
                        <p class='field'><label for='pass'>Tel: 11.22.33.44.55</label></p>
                        <p class='field'><label for='pass'>Adresse XxXxX, ville</label></p>

                            <input type='submit' id='do_login' value='M O D I F I E R' />
                      </div>
                    </div>
                </div>
